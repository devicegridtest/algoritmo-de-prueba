...
.stButton > button {
    ...
    border-radius: 8px;
    padding: 10px 20px;
    font-size: 18px; /* Slightly larger for icon */
...
# --- Force refresh with HAMBURGER ICON ---
